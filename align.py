...
if __name__ == "__main__":
    ...
    parser.add_argument("algorithm", type = str,
                                        help = "The algorithm you want to use. [Accepted param: 'SmithWaterman', 'Other']")

    parser.add_argument("seq1", type = str,
                                        help = "The first sequence you want to align")

    parser.add_argument("seq2", type = str,
                                        help = "The second sequence you want to align")

    parser.add_argument("-s", "--scores", type = int, nargs=3, default=[1,-1,-2],
            help="The scores to be used during the lignment. How to use: '-s 2 -2 -3'. Default values: match=1, mismatch=-1, gap=-2]")

    parser.add_argument("-f", "--filter", type = str, default="best",
            help="Filtering parameters used to retrieve the desired alignments.Accepted parameters: 'best' - get the alignments with the highest score -, 'all' - get all the possible alignment [Default: 'best']")
    ...
    #        help="The format of the input sequences. Select between [fasta,txt]. Default: fasta")
