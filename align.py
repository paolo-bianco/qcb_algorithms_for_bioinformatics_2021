...
if __name__ == "__main__":
    ...
    parser.add_argument("-f", "--filter", type = str, default="best",
            help="Filtering parameters used to retrieve the desired alignments.Accepted parameters: 'best' - get the alignments with the highest score -, 'all' - get all the possible alignment [Input type: <str>. Default: 'best']")
